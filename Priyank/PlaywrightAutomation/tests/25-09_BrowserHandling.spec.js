...
const [newPage] = await Promise.all([page.context().waitForEvent('page'), lipstick1.click()])
...
await page.goto("https://www.nykaa.com/");
  ...
  const [newPage1] = await Promise.all([contextA.waitForEvent('page'), lipstick2.click()])
